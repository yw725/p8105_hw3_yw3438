...
representing data value and x-axis showing the locations in NY State.
The line plot with value points shows the specific data value and the
differences in different locations in 2006 and 2010. The plot can
represent the general health conditions of people in specific districts
and the difference of health conditions between poeple from different
districts in 2006 and 2010.
...
week, the total activity is quite low on Saturday.
...
From the plot, it can be discovered that the patient’s 24-hour activity
time courses on Monday increased from week 1 to week 3 and dropped from
week 4 to week 5, while Tuesday, Wednesday, Thursday almost remained the
same from week 1 to week 5 and increased slightly. The patient’s 24-hour
activity time courses of Saturday and Sunday all dropped from week 2 to
week 5, while Saturday’s increased a little from week 1 to week 2 and
Sunday’s remained dropping.
